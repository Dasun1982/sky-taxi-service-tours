...
const vehicles = [
  ["toyota-prius", "Affordable private car for Nuwara Eliya airport transfer, tea country trips, and short hill country rides."],
  ["honda-insight", "Clean hybrid option for taxi in Nuwara Eliya, hotel pickups, and budget-friendly private transfers."],
  ["honda-shuttle", "Luggage-friendly wagon for airport transfers, Ella routes, Kandy trips, and family hill country travel."],
  ["honda-vezel", "Comfortable SUV for private driver Nuwara Eliya routes through mountain roads and longer island travel."],
  ["honda-freed", "Family-friendly vehicle for hill country transfers, luggage, hotel pickups, and custom Sri Lanka routes."],
  ["toyota-kdh-van", "Spacious van for groups, families, Colombo airport to Nuwara Eliya taxi routes, and luggage-heavy trips."],
].map(([id, text]) => {
    ...
    <div className="page colombo-airport-page nuwara-eliya-taxi-page">
      ...
      >
        <div className="premium-hero-actions">
          <a className="button button--primary" href={buildWhatsAppLink(nuwaraEliyaTaxiMessage())} target="_blank" rel="noreferrer">
